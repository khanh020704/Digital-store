            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="{{ $user->avatar ? asset($user->avatar) : asset('admin/assets/images/users/5.jpg') }}" class="rounded-circle" width="150"/>
                                    <h4 class="card-title m-t-10">{{ $user->name }}</h4>
                                    <h6 class="card-subtitle">{{ $user->level == 1 ? 'Admin' : 'Member' }}</h6>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                method="POST" action="{{ route('admin.user.profile.update') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" name="email" value="{{ $user->email }}" readonly class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="id_country" class="form-control form-control-line">        
                                                ...
                                                <option value="{{ $item->id }}" {{ $user->id_country == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach                                       
